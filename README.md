...
<img src="https://i.ibb.co/y5NtCdd/Magento2-5.png" alt="Magento2-5" border="0">

## Features:

1. Extension to show timer of shipping cut off.
2. Admin can manage timer from backend.
3. Looks like core functionality of Magento (at backend as well as frontend)
4. Unencrypted code for easy customization

# Installation Instruction

* Copy the content of the repo to the <b>app/code/Magelumen/ShippingTimer/</b> folder
* Run command:
